...
export type EncryptedDocumentInitParameters = {
    /**
     * - The URL of the PDF.
     */
    url?: string | URL | undefined;
    ...
    pdfBug?: boolean | undefined;
    /**
     * - The algorithm to be used for decrypting the PDF.
     */
...
export type GetDocumentParameters = string | URL | TypedArray | ArrayBuffer | PDFDataRangeTransport | DocumentInitParameters | EncryptedDocumentInitParameters;
